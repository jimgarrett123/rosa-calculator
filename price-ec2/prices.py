...
def get_products(ec2_type, ec2_plan, region_name):
...
if __name__ == '__main__':
    ...
    with open('error.log', 'a') as file:
        for ec2_type in ec2_types:
            try:
                product = get_products(ec2_type, arg_ec2_plan, region_name)
                results.append(product)
            except:
                file.write("[error] " + ec2_type + '/' + arg_ec2_plan + '/' + region_name) 
